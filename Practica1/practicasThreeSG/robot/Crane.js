...
class Crane extends THREE.Object3D {
  ...
  createMast () {
    var mast = new THREE.Mesh (
      new THREE.CylinderGeometry (0.3, 0.3, 5, 16, 8), this.material);
    mast.geometry.applyMatrix (new THREE.Matrix4().makeTranslation (0, 3.2, 0));
  ...
  createJib () {
    this.jib = new THREE.Mesh (
      new THREE.BoxGeometry (this.craneWidth, this.craneWidth/10, this.craneWidth/10),
                          this.material);
    this.jib.geometry.applyMatrix (new THREE.Matrix4().makeTranslation (0.3*this.craneWidth, 100, 0));
  ...
  createTrolleyStringHook () {
    this.trolley = new THREE.Mesh (
      new THREE.BoxGeometry (this.craneWidth/10, this.trolleyHeight, this.craneWidth/10),
                              this.material);
    this.trolley.geometry.applyMatrix (new THREE.Matrix4().makeTranslation (0, 100, 0));
    ...
    this.string.geometry.applyMatrix (new THREE.Matrix4().makeTranslation (0, 100, 0));
    ...
    this.hook = new THREE.Mesh (
      new THREE.CylinderGeometry (this.craneWidth/40, this.craneWidth/40, this.baseHookHeight, 16, 1),
                           this.material);
    this.hook.geometry.applyMatrix (new THREE.Matrix4().makeTranslation (0, 100, 0));
